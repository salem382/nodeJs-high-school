...
class Feedback {
    ...
    updateFeedback(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, ApiError_1.catchError)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
                const { feedback_id, rate, desc } = req.body;
                const feedback = yield feedBackMode_1.default.findByIdAndUpdate({ _id: feedback_id, userId: req.user_id }, { rate, desc }, { new: true });
                if (!feedback)
                    return next(new ApiError_1.AppError('not found', 404));
                return res.json({ message: "success" });
            }))(req, res, next);
