...
const buyModel_1 = __importDefault(require("../models/buyModel"));
class Book {
    getAllBooks(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, ApiError_1.catchError)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
                const books = yield bookModel_1.default.find().populate('feedBacks');
    ...
    buyBook(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, ApiError_1.catchError)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield buyModel_1.default.insertMany({ userId: req.user_id, bookId: book_id });
                return res.json({ message: "success" });
            }))(req, res, next);
        });
    }
